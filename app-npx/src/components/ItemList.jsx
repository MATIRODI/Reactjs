...
const ItemList = () => {
  ...
  //esta constante guarda la referencia a una instancia de la clase Promise, en la cual hay un setTimeout con 2 segundos que devuelve mi array de productos como parámetro en el "resolve".
